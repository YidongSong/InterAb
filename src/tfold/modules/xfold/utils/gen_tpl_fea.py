...
from openfold.utils.feats import build_template_pair_feat
from openfold.utils.feats import build_template_angle_feat
from openfold.utils.tensor_utils import tensor_tree_map

from tfold.modules.xfold.utils.constants import *
...
def get_template_features(feature_dict, tpl_num = 4, atom = 'CB', mask_index = -1, is_train = False):
    ...
    if feature_dict['template_all_atom_masks'].size == 0:
