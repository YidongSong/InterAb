...
from tfold.modules.common import DropoutRowwise
from tfold.modules.common import chunk_layer

from tfold.modules.evoformer.outer_product_mean import OuterProductMeanMSA
from tfold.modules.attention import TriangleAttention
from tfold.modules.attention import MSARowAttentionWithPairBias
from tfold.modules.attention import MSAColumnAttention
from tfold.modules.attention import TriangleMultiplicationIncoming
from tfold.modules.attention import TriangleMultiplicationOutgoing
    ...
    def forward(self,
        ...
        for block in self.blocks:
            if self.activation_checkpoint:
                m, z = self.activation_checkpoint_fn(block, m, z, msa_mask, pair_mask, chunk_size)
            else:
