...
from tfold.third_parties.tfold_released.protein.prot_constants import RESD_NAMES_1C, N_ANGLS_PER_RESD
from tfold.third_parties.tfold_released.transform import update_se3_trans
