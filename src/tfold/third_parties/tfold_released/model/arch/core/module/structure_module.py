...
from tfold.third_parties.tfold_released.model.layer import LayerNorm, Linear
from tfold.third_parties.tfold_released.protein import ProtStruct, ProtConverter
from tfold.third_parties.tfold_released.transform import rot2quat
...
class StructureModule(nn.Module):
    ...
    def forward( self, aa_seq, sfea_tns, pfea_tns, encd_tns,
                 n_lyrs=-1,
                 asym_id=None,
                 cord_tns=None,
                 cmsk_mat=None,
