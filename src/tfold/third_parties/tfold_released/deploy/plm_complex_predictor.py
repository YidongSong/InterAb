...
from tfold.third_parties.tfold_released.config import get_config, CN
from tfold.third_parties.tfold_released.model import ComplexLiteModel
...
class PLMComplexPredictor(BaseStructurePredictor):
    ...
    @classmethod
    def restore_from_module(cls, ppi_path, trunk_path):
