...
def nonensembled_transform_fns_onlyTPL(common_cfg, mode_cfg):
    """Input pipeline data transformers that are not ensembled."""
...
def process_tensors_from_config_only_TPL(tensors, common_cfg, mode_cfg):
    """Based on the config, apply filters and transformations to the data."""

    nonensembled = nonensembled_transform_fns_onlyTPL(common_cfg, mode_cfg)
