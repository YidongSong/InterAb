...
Python 3.8.16, numpy v1.24.3, pyg v2.3.0, pytorch v2.0.0, biopython v1.83, debugpy v1.6.7, decorator v5.1.1, filelock, v3.12.1, gmp v6.2.1, idna v3.4, ipython v8.12.0, scipy 1.10.1, and six v1.16.0
